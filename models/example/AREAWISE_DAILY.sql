...
SELECT DATE, LOCATION, SUM(POPULATION) AS POPULATION, SUM(TOTAL_ACTIVE_CASES) AS TOTAL_ACTIVE_CASES, SUM(TOTAL_CASES) AS TOTAL_CASES,
...
GROUP BY LOCATION,DATE ORDER BY DATE